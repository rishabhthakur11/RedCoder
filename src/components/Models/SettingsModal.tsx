    ...
    <div className="text-white z-40">
      ...
      >
        <div className="flex min-h-screen items-center justify-center px-4">
          ...
          >
            <div className="fixed inset-0 bg-boxBrown opacity-60"></div>
          </div>

          <div className="my-8 inline-block min-w-full transform rounded-[13px] text-left transition-all bg-mildBrown md:min-w-[420px] shadow-level4 shadow-lg p-0 w-[600px] !overflow-visible  scale-100">
            {/* setting header */}
            <div className="flex items-center border-b px-5 py-4 text-lg font-medium  border-darkdivider">
              Settings
              <button
                ...
                <div className="w-[170px]">
                  <div className="relative">
                    <button
                      ...
                      className="flex cursor-pointer items-center rounded px-3 py-1.5 text-left focus:outline-none whitespace-nowrap bg bg-dark3 hover:bg-dark2 active:bg-dark3 w-full justify-between"
                      type="button"
                    >
                      {fontSize}
                      <BsChevronDown />
                    ...
                    {settings.dropdownIsOpen && (
                      <ul
                        className="absolute mt-1 max-h-56 overflow-auto rounded-lg p-2 z-50 focus:outline-none shadow-lg   w-full bg-boxBrown"
                        style={{
                          filter:
...
const SettingsListItem: React.FC<SettingsListItemProps> = ({
  ...
  return (
    <li className="relative flex h-8 cursor-pointer select-none py-1.5 pl-2 text-white hover:bg-dark3 rounded-lg">
      <div
      ...
      <span
        className={`text-blue dark:text-darkBlue flex items-center pr-2 ${
